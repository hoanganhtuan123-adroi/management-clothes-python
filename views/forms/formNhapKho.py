...
class NhapKhoForm(tk.Toplevel):
    def __init__(self, parent):
        ...
        ttk.Label(input_frame, text="Lô hàng:").grid(row=5, column=0, padx=5, pady=5, sticky="e")
        self.lo_hang = ttk.Entry(input_frame, width=25)
        self.lo_hang.grid(row=5, column=1, padx=5, pady=5)
